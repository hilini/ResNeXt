...
import wandb
wandb.init(project="resnext",entity ="hi_lini")
...
cosine_scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, 300, eta_min=0, last_epoch=-1)
